 ...
 * 
    {
        ...
        avatarURL: "https://pbs.twimg.com/profile_images/1541087885/DSC_00951_400x400.jpg", // this is the url for the profile avatar
...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "Pamela";
  if (variables.lastName == null) variables.lastName = "Godoy";
  if (variables.role == null) variables.role = "Web Developer";
  if (variables.country == null) variables.country = "CHILITO";
